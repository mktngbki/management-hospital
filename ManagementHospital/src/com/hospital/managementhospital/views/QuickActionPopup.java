...
public class QuickActionPopup extends MyPopupWindow implements OnDismissListener {
    ...
    public void show (View anchor) {
        ...
        if(onTop){
        	mWindow.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.popup_inline_error_above_holo_light));
            mWindow.showAtLocation(anchor, Gravity.NO_GRAVITY, anchorRect.left -10, yPos - 60);
        }else{
        	mWindow.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.popup_inline_error_holo_light));
            mWindow.showAtLocation(anchor, Gravity.NO_GRAVITY, anchorRect.left -10, yPos - 10);
        }
        Log.e("QuickActionPopup", "anchorTop = "+ anchorRect.top + " anchorHeight = " + anchor.getHeight() + " yPos = " + yPos);
    }
